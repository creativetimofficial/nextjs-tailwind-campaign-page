...
export const metadata: Metadata = {
  ...
  keywords:
    "campaign page, campaign page template, campaign template, landing page, tailwind, tailwind css, tailwind template, marketing campaign, online campaign, promotional page, tailwind css, material tailwind, free template, marketing, business campaign, campaign builder, responsive design, campaign showcase",
};
  ...
  return (
    <html lang="en">
      <head>
        ...
        <link
          rel="canonical"
          href="https://www.creative-tim.com/product/nextjs-tailwind-campaign-page"
        />

        <meta
          itemProp="name"
          content="NextJS Tailwind Campaign Page by Creative Tim"
        />
        <meta
          itemProp="description"
          content="Introducing Tailwind Campaign Page, an all-inclusive and visually captivating campaign landing page template built on the foundation of Tailwind CSS and Material Tailwind."
        />

        <meta
          itemProp="image"
          content="https://s3.amazonaws.com/creativetim_bucket/products/743/original/material-tailwind-react-campaign-template-thumbnail.jpg"
        />
        ...
        <meta
          property="og:url"
          content="http://demos.creative-tim.com/nextjs-tailwind-campaign-page"
        />
        <meta
          property="og:image"
          content="https://s3.amazonaws.com/creativetim_bucket/products/743/original/material-tailwind-react-campaign-template-thumbnail.jpg"
        ...
        <link
          rel="shortcut icon"
          href="/nextjs-tailwind-campaign-page/favicon.png"
          type="image/png"
        />
      </head>
